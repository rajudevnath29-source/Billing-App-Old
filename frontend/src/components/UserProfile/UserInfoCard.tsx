...
export default function UserInfoCard() {
  ...
  if (loading || !user || !formData) return <div className="p-6">Loading...</div>;
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    ...
                    <Input name="zipcode" type="text" value={formData.zipcode} onChange={handleChange} />
                  </div>

                  <div>
                    <Label>GST ID</Label>
                    <Input name="gstno" type="text" value={formData.gstno} onChange={handleChange} className="uppercase" />
                  </div>
                </div>
              </div>
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    <Label>X.com</Label>
                    <Input name="socialx" type="text" value={formData.socialx} onChange={handleChange} />
                  </div>
                  ...
                  <div>
                    ...
                    <Input name="socialinstagram" type="text" value={formData.socialinstagram} onChange={handleChange} />
                  </div>
                </div>
              </div>
